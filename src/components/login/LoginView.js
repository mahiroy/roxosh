...
<div className="container mb-5">
    <div className="card mx-auto mt-5 pb-3 shadow rounded b-shad" style={{width: "25rem"}}>
      <div className="card-body">
        ...
        <form className="needs-validation"  autoComplete="off"  noValidate>
          <div className="form-group">
            ...
            <input type="email" name="email" className="form-control" placeholder="abc@abc.com" id="userEmail"
              aria-describedby="emailHelp" value="abc@abc.com" required />
          ...
          <div className="form-group">
            ...
            <input type="password" className="form-control" placeholder="******" name="password" id="userPassword"
              aria-describedby="passwordHelp"  value="Password"  required minLength="6"/>
        ...
        <Link to="/register" className="btn btn-dark btn-sm w-100 mt-2">Create account</Link>
